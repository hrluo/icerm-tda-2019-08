...
Nsample=200
lp=2
lq_array=np.array([2,8,32,128,512])
...
points = eg.pinched_torus_example(n=Nsample)
...
for lq in lq_array:
    for alpha in alpha_array:
        ...
        plotCir(res_gd,timestr+'PichedTorus_gradient',ctr=counter)
        plotCir(res_adam,timestr+'PinchedTorus_adams',ctr=counter)
        plotCir(res_adagrad,timestr+'PinchedTorus_adagrad',ctr=counter)
